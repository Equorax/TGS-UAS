...
#     def okefilm(self, pilih_film,kursi_terpilih):
#         if not pilih_film.curselection():
#             messagebox.showwarning("Peringatan", "Silahkan Pilih Film")
#             return
...
#         self.snack = Parent
#         self.akses_nota = nt
#         self.snack_total_value = 0
        
#     def snack1(self, film_terpilih, kursi_terpilih):
#         for i in self.snack.winfo_children():
#             i.destroy()
#         self.list_snack(film_terpilih, kursi_terpilih)

#     def list_snack(self, film_terpilih, kursi_terpilih):
#         # Layout setup, omitted for brevity

#         # Sample snack item setup
...
#         # Other snack items setup, omitted for brevity

#         knfrm_flm = Button(self.snack, text="Konfirmasi", command=lambda: self.akses_nota.nota1(film_terpilih, kursi_terpilih, self.snack_total_value))
#         knfrm_flm.grid(row=7, column=0, padx=10, pady=10, columnspan=3)

#         # Frame for entering snack quantities
...
#         self.input_snack_quantities = {}
#         snack_items = [("French Fries", 20000), ("Hotdog", 25000), ("Popcorn", 20000), ("Burger", 30000), ("Soda", 15000), ("Air Mineral", 10000)]
#         for i, (snack_name, snack_price) in enumerate(snack_items):
#             row, col = divmod(i, 3)
#             label = Label(Frame5, text=snack_name, font=("Times New Roman", 15), bg="#5E0101", fg="#BE965A")
#             label.grid(row=row, column=col * 2, padx=1, pady=5, sticky="w")
#             entry = Entry(Frame5, width=5, borderwidth=5, relief=GROOVE)
#             entry.grid(row=row, column=col * 2 + 1, padx=10, pady=10)
#             entry.insert(0, 0)
#             self.input_snack_quantities[snack_name] = (entry, snack_price)

#         total_label = Label(Frame5, text="Total", font=("Times New Roman", 15), bg="#5E0101", fg="#BE965A")
#         total_label.grid(row=5, column=0, padx=1, pady=10, sticky="w")
#         rp_label = Label(Frame5, text="Rp", font=("Times New Roman", 15), bg="#5E0101", fg="#BE965A")
#         rp_label.grid(row=6, column=0, padx=1, pady=10, sticky="w")
...
#         cek_harga_snack = Button(Frame5, text="Cek", command=self.total_harga_snack, bg="snow1", fg="black", relief=RAISED)
#         cek_harga_snack.grid(row=7, column=0, padx=1, pady=10, sticky="n", columnspan=4)
#         del_harga_snack = Button(Frame5, text="Del", command=self.hapus_harga_snack, bg="snow1", fg="black", relief=RAISED)
#         del_harga_snack.grid(row=7, column=1, padx=1, pady=10, sticky="n", columnspan=4)

#     def total_harga_snack(self):
#         self.snack_total_value = 0
#         for entry, price in self.input_snack_quantities.values():
#             self.snack_total_value += int(entry.get()) * price
#         total_formatted = "{:,.0f}".format(self.snack_total_value)
#         self.Total_snck.delete(0, END)
#         self.Total_snck.insert(0, total_formatted)

#     def hapus_harga_snack(self):
#         for entry, _ in self.input_snack_quantities.values():
#             entry.delete(0, END)
#             entry.insert(0, 0)
#         self.Total_snck.delete(0, END)
#         self.Total_snck.insert(0, "0")
...
#     def nota1(self, film_terpilih, kursi_terpilih, snack_total_value):
#         for i in self.nota.winfo_children():
#             i.destroy()
#         self.nota_bayar(film_terpilih, kursi_terpilih, snack_total_value)

#     def nota_bayar(self, film_terpilih, kursi_terpilih, snack_total_value):
...
#         jmlh_kur = Label(Frame9, text="Jumlah Kursi", font=("Times New Roman", 15), bg="azure4", fg="black")
#         jmlh_kur.grid(row=2, column=0, padx=1, pady=5, sticky="w")
#         input_jmlh_kur = Entry(Frame9, width=20, borderwidth=5, relief=GROOVE)
#         input_jmlh_kur.grid(row=2, column=1, padx=10, pady=10)
#         input_jmlh_kur.insert(0, 0)

#         Harga_total_nt = Label(Frame9, text="Harga", font=("Times New Roman", 15), bg="azure4", fg="black")
#         Harga_total_nt.grid(row=3, column=0, padx=1, pady=5, sticky="w")
#         input_Harga_Total_nt = Entry(Frame9, width=20, borderwidth=5, relief=GROOVE)
#         input_Harga_Total_nt.grid(row=3, column=1, padx=10, pady=10)
#         input_Harga_Total_nt.insert(0, "Rp {:,.0f}".format(snack_total_value))
